...
public class SimpleExample {
    ...
    private void run(long a_maxReads, String a_topic, int a_partition, List<String> a_seedBrokers, int a_port) throws Exception {
        ...
        SimpleConsumer consumer = new SimpleConsumer(leadBroker, a_port, 100000, 64 * 10240000, clientName);
//        long readOffset = getLastOffset(consumer, a_topic, a_partition, kafka.api.OffsetRequest.EarliestTime(), clientName);
        ...
        while (a_maxReads > 0) {
            if (consumer == null) {
                consumer = new SimpleConsumer(leadBroker, a_port, 100000, 64 * 10240000, clientName);
            }
